...
const listReducer = (state = initialState, action: ListsAction): ListState => {
  ...
  switch (action.type) {
    ...
    case DELETE_LIST:
      ...
      saveListToLS(clonedListsFromLS2);
      return {
        ...state,
    ...
    case UPDATE_LIST:
      ...
      saveListToLS(clonedListsFromLS3);
      return {
        ...state,
    ...
    case ADD_TASK:
      ...
      saveListToLS(clonedListsFromLS4);
      return {
        ...state,
    ...
    case DELETE_TASK:
      ...
      saveListToLS(clonedListsFromLS5);
      return {
        ...state,
    ...
    case UPDATE_TASK:
      ...
      saveListToLS(clonedListsFromLS6);
